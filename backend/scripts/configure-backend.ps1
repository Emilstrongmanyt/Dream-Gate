...
Write-Host "  2. Deploy edge functions (Supabase Dashboard -> Edge Functions, or install CLI later)"
Write-Host "  3. Start match server: .\scripts\start-match-server.ps1"
Write-Host "  4. Test health: .\scripts\test-backend.ps1"